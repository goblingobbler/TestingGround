...
class Helix():
    def __init__(self, radius, point_count=0, angle_start=0, step=.2, height=10, reverse=False):
        self.radius = radius
    ...
    def create_circles(self, circle_radius, point_count=24, ossilation=0, ossilation_steps=24, ossilation_start=0, rotation_steps=0):
        circles = []
        ...
        while elevation <= self.height:
            ...
            new_circle = Circle(center, radius=radius, point_count=point_count, starting_angle=circle_starting_angle)
